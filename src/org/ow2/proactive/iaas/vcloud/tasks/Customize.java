...
public class Customize extends IaasExecutable {
    ...
    public Serializable execute(TaskResult... results) throws Throwable {
        ...
        try {
            System.out.println("[Customize task] Customizing all VMs from Vapp " + "...");
            ...
            System.out.println("[Customize task] Using script: " + script);

            api.customize(vappId, script);
        } catch (Throwable e) {
            e.printStackTrace();
        } finally {
            if (api != null) {
