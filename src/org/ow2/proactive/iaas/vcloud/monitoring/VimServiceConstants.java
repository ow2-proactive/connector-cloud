...
public class VimServiceConstants {
    ...
    /*
     * The speed of the CPU cores. This is an average value if there are
     * multiple speeds. The product of cpuMhz and numCpuCores is approximately
     * equal to the sum of the MHz for all the individual cores on the host.
     */
    ...
    public static final String[] HOST_STATIC_PROPERTIES = new String[] {
            PROP_HOST_CPU_CORES, PROP_HOST_CPU_FREQUENCY, PROP_HOST_CPU_USAGE,
            PROP_HOST_MEMORY_TOTAL, PROP_HOST_MEMORY_USAGE,
    ...
    public static final String[] DYNAMIC_PROPERTIES = new String[] {
            PROP_NET_RX_RATE, PROP_NET_TX_RATE, PROP_NET_USAGE };
